  ...
  return (
    <div className={styles.bg}>
      ...
      <div className={styles.pageContent}>
        ...
        <div className="text-center"><a className={styles.githubLink} href="https://github.com/kozykrew/uchi" target="_blank" rel="noreferrer">UCHI on GitHub<img className={styles.github} src="/icons/github_dark.svg" alt={"UCHI on GitHub"} /></a></div>
      </div>
      <div className={styles.visualContainer}>
